...
export const CanvasTutorial = () => {
  ...
  return (
    <>
      ...
      <Scrim open={isOpen} isDismissable onClose={handleClose}>
          ...
          <Dialog.CustomContent className={styles.customContent}>
            ...
            <div className={styles.sections}>
              ...
              >
                ...
                the left yellow square <InlineImage src={subActivity} /> to add
                a new sub activity.
              </CanvasTutorialSection>
              <CanvasTutorialSection
                ...
                image={addNewWait}
              >
                Hover over a main activity, sub activity, wait, or choice.
                Below, you&apos;ll see three squares. Click the right orange
                square <InlineImage src={wait} /> to add a new wait.
              </CanvasTutorialSection>
              <CanvasTutorialSection
                ...
                image={addNewChoice}
              >
                Hover over a main activity, sub activity, wait, or choice on
                your canvas. Below, click the central yellow diamond{" "}
              ...
              >
                Hover over the merge circle of a card at the end of a choice
                path. <InlineImage src={merge} /> Drag and drop it onto the card
                you wish to merge into.
              </CanvasTutorialSection>
            </div>
