...
export DEV_INSTRUMENTATION_KEY=$NEXT_PUBLIC_INSTRUMENTATION_KEY
...
export TEST_INSTRUMENTATION_KEY=$NEXT_PUBLIC_INSTRUMENTATION_KEY
...
export QA_INSTRUMENTATION_KEY=$NEXT_PUBLIC_INSTRUMENTATION_KEY
...
export PROD_INSTRUMENTATION_KEY=$NEXT_PUBLIC_INSTRUMENTATION_KEY
