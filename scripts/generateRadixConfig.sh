...
export DEV_CONNECTION_STRING=$APPINSIGHTS_INSTRUMENTATIONKEY
...
export TEST_CONNECTION_STRING=$APPINSIGHTS_INSTRUMENTATIONKEY
...
export QA_CONNECTION_STRING=$APPINSIGHTS_INSTRUMENTATIONKEY
...
export PROD_CONNECTION_STRING=$APPINSIGHTS_INSTRUMENTATIONKEY
