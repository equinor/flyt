...
export DEV_INSTRUMENTATION_KEY=$INSTRUMENTATION_KEY
...
export TEST_INSTRUMENTATION_KEY=$INSTRUMENTATION_KEY
...
export QA_INSTRUMENTATION_KEY=$INSTRUMENTATION_KEY
...
export PROD_INSTRUMENTATION_KEY=$INSTRUMENTATION_KEY
