...
export DEV_CONNECTION_STRING=$NEXT_PUBLIC_INSTRUMENTATION_KEY
...
export TEST_CONNECTION_STRING=$NEXT_PUBLIC_INSTRUMENTATION_KEY
...
export QA_CONNECTION_STRING=$NEXT_PUBLIC_INSTRUMENTATION_KEY
...
export PROD_CONNECTION_STRING=$NEXT_PUBLIC_INSTRUMENTATION_KEY
