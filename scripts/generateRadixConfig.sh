...
export DEV_CONNECTION_STRING=$NEXT_PUBLIC_CONNECTION_STRING
...
export TEST_CONNECTION_STRING=$NEXT_PUBLIC_CONNECTION_STRING
...
export QA_CONNECTION_STRING=$NEXT_PUBLIC_CONNECTION_STRING
...
export PROD_CONNECTION_STRING=$NEXT_PUBLIC_CONNECTION_STRING
